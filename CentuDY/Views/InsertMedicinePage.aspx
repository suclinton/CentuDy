<%@ Page Title="" Language="C#" MasterPageFile="~/Views/HomeMasterPage.Master" AutoEventWireup="true" CodeBehind="InsertMedicinePage.aspx.cs" Inherits="CentuDY.Views.InsertMedicinePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <asp:Button ID="insertBtn" OnClick="insertBtn_Click" runat="server" Text="Insert Medicine" />
    </div>
</asp:Content>
